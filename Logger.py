...
# Zwiększenie czcionki i przestrzeni wokół przycisku
tk.Button(form_frame, text="Dodaj QSO", command=add_entry, font=("Helvetica", 16, "bold"), padx=20, pady=10).grid(row=4, column=0, columnspan=2, pady=10)
